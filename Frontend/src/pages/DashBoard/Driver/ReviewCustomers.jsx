...
const DriverReviewCustomers = () => {
  ...
  const [reviewType, setReviewType] = useState("compliment"); // ⭐ NEW
  ...
  const submitCustomerReview = async () => {
    ...
    const payload = {
      ...
      restaurant_name: reviewTarget.restaurant_name,
    };
          ...
          <div className="customer-review-card" key={o.order_id}>
            ...
            <button
              className={`review-btn ${
                alreadyReviewed ? "disabled-review" : ""
              }`}
      ...
      {reviewTarget && (
        <div className="review-modal-overlay">
          <div className="review-modal">
            <h3>
              Review Customer: {reviewTarget.users.first_name}{" "}
              {reviewTarget.users.last_name}
            </h3>
